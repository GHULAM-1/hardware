...
/**
 * "My account" — edit your own name, photo and password. Moved here from the
 * standalone /profile page so all personal + app settings live in one place.
 * Available to every signed-in user (each edits only their own row via RLS).
 */
