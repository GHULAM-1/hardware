...
/**
 * Staff detail content (personal details, this month's attendance, salary status,
 * actions) — shared by the staff detail dialog and the quick-search preview pane.
 * `onNavigate` fires before the "view salary" link navigates (to close the host).
 * Title is the caller's.
 */
export function StaffDetailBody({ staff, onNavigate }: { staff: Staff; onNavigate?: () => void }) {
    ...
    <div>
      ...
      <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:justify-end">
        <Button asChild variant="outline" className="w-full sm:w-auto">
          <Link href="/staff/salary" onClick={onNavigate}>
